...
1. Builds and runs the AppKit native interaction/resource test.
2. Uses `vtool` to require that the final executable, Objective-C bridge object, and representative project Haskell objects have the requested `minos` value.
