...
foreign import ccall unsafe "haskelui_macos_shutdown"
  c_shutdown :: IO ()

foreign import ccall unsafe "haskelui_macos_version_major"
  c_versionMajor :: IO CInt

foreign import ccall unsafe "haskelui_macos_version_minor"
  c_versionMinor :: IO CInt

foreign import ccall unsafe "haskelui_macos_version_patch"
  c_versionPatch :: IO CInt

foreign import ccall unsafe "haskelui_macos_window_create"
  c_createWindow :: Word64 -> CString -> Ptr CMacRect -> IO (Ptr MacWindowHandle)

foreign import ccall unsafe "haskelui_macos_window_set_title"
  c_windowSetTitle :: Ptr MacWindowHandle -> CString -> IO ()

foreign import ccall unsafe "haskelui_macos_window_show"
  c_windowShow :: Ptr MacWindowHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_window_destroy"
  c_windowDestroy :: Ptr MacWindowHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_workspace_begin"
...
foreign import ccall unsafe "haskelui_macos_workspace_tab_group_set"
  c_workspaceTabGroupSet :: Ptr MacWindowHandle -> Word64 -> Word64 -> IO ()

foreign import ccall unsafe "haskelui_macos_workspace_tab_set"
  c_workspaceTabSet :: Ptr MacWindowHandle -> Word64 -> Word64 -> CString -> CInt -> CInt -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_workspace_end"
  c_workspaceEnd :: Ptr MacWindowHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_label_create"
  c_createLabel :: Ptr MacWindowHandle -> Word64 -> CString -> Ptr CMacRect -> IO (Ptr MacControlHandle)

foreign import ccall unsafe "haskelui_macos_button_create"
  c_createButton :: Ptr MacWindowHandle -> Word64 -> CString -> Word64 -> Ptr CMacRect -> IO (Ptr MacControlHandle)

foreign import ccall unsafe "haskelui_macos_text_field_create"
...
foreign import ccall unsafe "haskelui_macos_catalog_control_set_primary_text"
  c_catalogSetPrimaryText :: Ptr MacControlHandle -> CString -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_secondary_text"
  c_catalogSetSecondaryText :: Ptr MacControlHandle -> CString -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_state"
  c_catalogSetState :: Ptr MacControlHandle -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_row_sizing"
  c_catalogSetRowSizing :: Ptr MacControlHandle -> CInt -> CDouble -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_numeric"
  c_catalogSetNumeric :: Ptr MacControlHandle -> CDouble -> CDouble -> CDouble -> CDouble -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_color"
  c_catalogSetColor :: Ptr MacControlHandle -> CDouble -> CDouble -> CDouble -> CDouble -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_date_time"
  c_catalogSetDateTime :: Ptr MacControlHandle -> CInt -> CInt -> CInt -> CInt -> CInt -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_command"
  c_catalogSetCommand :: Ptr MacControlHandle -> Word64 -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_begin_items"
  c_catalogBeginItems :: Ptr MacControlHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_add_item"
  c_catalogAddItem :: Ptr MacControlHandle -> Word64 -> CString -> CString -> CString -> CInt -> CInt -> Word64 -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_end_items"
  c_catalogEndItems :: Ptr MacControlHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_tooltip"
  c_catalogSetTooltip :: Ptr MacControlHandle -> CString -> IO ()

foreign import ccall unsafe "haskelui_macos_catalog_control_set_presentation"
  c_catalogSetPresentation :: Ptr MacControlHandle -> CInt -> Word64 -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_text"
  c_controlSetText :: Ptr MacControlHandle -> CString -> IO ()

foreign import ccall unsafe "haskelui_macos_text_editor_begin_presentation"
  c_textEditorBeginPresentation :: Ptr MacControlHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_text_editor_set_base_style"
  c_textEditorSetBaseStyle :: Ptr MacControlHandle -> Ptr CTextStyle -> IO ()

foreign import ccall unsafe "haskelui_macos_text_editor_apply_style"
...
foreign import ccall unsafe "haskelui_macos_control_measure"
  c_controlMeasure :: Ptr MacControlHandle -> CDouble -> CDouble -> Ptr CMacRect -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_enabled"
  c_controlSetEnabled :: Ptr MacControlHandle -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_control_focus"
  c_controlFocus :: Ptr MacWindowHandle -> Ptr MacControlHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_next_key"
  c_controlSetNextKey :: Ptr MacControlHandle -> Ptr MacControlHandle -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_parent_item"
  c_controlSetParentItem :: Ptr MacWindowHandle -> Ptr MacControlHandle -> Word64 -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_parent_tab"
  c_controlSetParentTab :: Ptr MacWindowHandle -> Ptr MacControlHandle -> Word64 -> Word64 -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_control_set_parent_status"
...
foreign import ccall unsafe "haskelui_macos_command_set"
  c_commandSet :: Word64 -> CString -> CString -> CInt -> IO ()

foreign import ccall unsafe "haskelui_macos_command_remove"
  c_commandRemove :: Word64 -> IO ()

foreign import ccall unsafe "haskelui_macos_open_text_files"
  c_openTextFiles :: IO ()

foreign import ccall unsafe "haskelui_macos_open_project_folder"
  c_openProjectFolder :: IO ()

foreign import ccall unsafe "haskelui_macos_debug_counters"
