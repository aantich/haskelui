# HaskeLUI AppKit backend

This package realizes the initial semantic HaskeLUI view through native AppKit objects. It is a vertical architectural slice, not a production backend.
